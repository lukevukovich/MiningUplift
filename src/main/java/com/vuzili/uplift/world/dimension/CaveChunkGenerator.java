...
public class CaveChunkGenerator extends NoiseChunkGenerator<CaveGenSettings> {
	   private final double[] field_222573_h = this.func_222572_j();

	   public CaveChunkGenerator(World p_i48694_1_, BiomeProvider p_i48694_2_, CaveGenSettings p_i48694_3_) {
	      super(p_i48694_1_, p_i48694_2_, 4, 8, 70, p_i48694_3_, false);
	   }
