...
public class SmelterFurnaceScreen extends ContainerScreen<SmelterFurnaceContainer> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Uplift.MOD_ID,
			"textures/gui/smelter.png");

	public SmelterFurnaceScreen(SmelterFurnaceContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
