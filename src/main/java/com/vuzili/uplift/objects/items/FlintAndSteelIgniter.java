...
public class FlintAndSteelIgniter extends Item {
   public FlintAndSteelIgniter(Item.Properties builder) {
      super(builder);
   }
...
public static boolean canSetFire(BlockState existingState, IWorld worldIn, BlockPos posIn) {
      BlockState blockstate = ((IgniterFire)BlockInit.igniter_fire).getStateForPlacement(worldIn, posIn);
      boolean flag = false;
