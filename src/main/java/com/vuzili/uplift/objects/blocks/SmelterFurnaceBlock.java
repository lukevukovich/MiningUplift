...
public class SmelterFurnaceBlock extends Block {

	public static final DirectionProperty FACING = BlockStateProperties.HORIZONTAL_FACING;

	public SmelterFurnaceBlock(Properties properties) {
		super(properties);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
		...
		if (stack.hasDisplayName()) {
			...
			if (tile instanceof SmelterFurnaceTileEntity) {
				((SmelterFurnaceTileEntity) tile).setCustomName(stack.getDisplayName());
			}
		}
	}
	...
	public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		...
		if (rand.nextDouble() < 0.1D) {
			worldIn.playSound(d0, d1, d2, SoundEvents.BLOCK_BLASTFURNACE_FIRE_CRACKLE, SoundCategory.BLOCKS, 1.0F, 1.0F,
					false);
		}
